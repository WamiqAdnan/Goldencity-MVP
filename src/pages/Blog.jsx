...
function Blog() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-transparent py-16">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-secondary-400 dark:text-platinum-400" />
                  <input
                    type="text"
